package com.atenea.qcb.youtube.incremental;
...
public class MainThread implements Runnable {
	...
	public synchronized void setQueryTraversal(String query) {
		...
		case "4":
			...
			LOGGER.info("PresenceAtBeginning");
		...
		case "5":
			...
			LOGGER.info("DomesticAnimalPicture");
		...
		case "6":
			...
			LOGGER.info("CrowdedDetectionVideo");
