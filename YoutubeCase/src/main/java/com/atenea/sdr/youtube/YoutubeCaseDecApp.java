...
import com.atenea.sdr.youtube.incremental.DecrementalSDRThread;
import com.atenea.sdr.youtube.incremental.MainThreadRemove;

public class YoutubeCaseDecApp {

	private final static Logger LOGGER = Logger.getLogger(YoutubeCaseDecApp.class.getName());
	...
	public static <E> void main(String[] args) throws Exception {
		...
		try (InputStream input = new FileInputStream("src/main/resources/config.properties")) {
			...
			// handler
			fh = new FileHandler("MyYoutubeLogFileDecremental" + fileWeight + "-" + query + "-" + records + "-" + recordsQuery + ".log",
					true);
