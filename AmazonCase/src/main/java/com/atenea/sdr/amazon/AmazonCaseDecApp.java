...
import com.atenea.sdr.amazon.algorithm.incremental.DecrementalSDRThread;
import com.atenea.sdr.amazon.algorithm.incremental.MainThreadRemove;

public class AmazonCaseDecApp {

	private final static Logger LOGGER = Logger.getLogger(AmazonCaseDecApp.class.getName());
	...
	public static <E> void main(String[] args) throws Exception {
		...
		try (InputStream input = new FileInputStream("src/main/resources/config.properties")) {
			...
			// handler
			fh = new FileHandler("MyAmazonLogFileDecremental" + fileWeight + "-" + query + "-" + records + "-" + recordsQuery + ".log",
					true);
