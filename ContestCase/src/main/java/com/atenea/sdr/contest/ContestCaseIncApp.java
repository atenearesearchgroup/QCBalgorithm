...
import com.atenea.sdr.contest.algorithm.incremental.IncrementalSDRThread;
import com.atenea.sdr.contest.algorithm.incremental.MainThread;

public class ContestCaseIncApp {
	private final static Logger LOGGER = Logger.getLogger(ContestCaseIncApp.class.getName());
	...
	public static <E> void main(String[] args) throws Exception {
		...
		try (InputStream input = new FileInputStream("src/main/resources/config.properties")) {
			...
			// handler
			fh = new FileHandler("MyContestLogFileIncremental" + fileWeight + "-" + query + "-" + records + "-" + recordsQuery + ".log",
					true);
